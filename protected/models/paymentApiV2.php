...
class paymentApiV2 extends CFormModel
{
	...
	public function rules()
	{
		return array(
			...
			array('boxSize,cDomain,aliases,dispEmails,pgpStrength,attSize,importPGP,contacts,delaySend,sendLimits,recipPerMail,folderExpiration,secLog,filtEmail', 'numerical', 'integerOnly'=>true,'allowEmpty' => false,'on'=>'calculatePrice'),
